...
describe('createConfig', function () {
  describe('server side', function () {
    ...
    describe('with a function for localePath', function () {
      var localePathFn = function localePathFn(locale, namespace, env, missing) {
        return "".concat(missing, "/").concat(env, "/").concat(namespace, "/").concat(locale, ".json");
      };
      ...
      it('returns a config whose localePath works as expected', function () {
        ...
        expect(config.backend.loadPath('en', 'common')).toBe('false/server/common/en.json');
        expect(config.backend.addPath('en', 'common')).toBe('true/server/common/en.json');
      });
  ...
  describe('client side', function () {
    ...
    describe('with a function for localePath', function () {
      ...
      it('returns a config whose localePath works as expected', function () {
        ...
        expect(config.backend.loadPath('en', 'common')).toBe('false/client/common/en.json');
        expect(config.backend.addPath('en', 'common')).toBe('true/client/common/en.json');
      });
    });
  });
});